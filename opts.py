...
parser.add_argument('--imSizeX', type=int, default=256, help='then crop to this size')
parser.add_argument('--imSizeY', type=int, default=256, help='then crop to this size')
